...
/** Tela de vitória — todos os itens coletados e o gelo processado. */
public class VictoryScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        Gdx.gl.glClearColor(0.03f, 0.1f, 0.05f, 1f);
        ...
        fontTitulo.setColor(Color.GREEN);
        layout.setText(fontTitulo, "MISSAO CUMPRIDA");
